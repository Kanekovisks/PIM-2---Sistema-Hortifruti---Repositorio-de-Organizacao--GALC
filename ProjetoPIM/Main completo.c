...
void menuVenda(Produto *produtos, int *count, int *venda_id);
...
void menuPrincipal(Produto *produtos, int *count, int *venda_id, int *user_count, Usuario *usuarios, Usuario *usuario_atual);
...
int main() {
    ...
    system("cls");
    menuPrincipal(produtos, &count, &venda_id, &user_count, usuarios, &usuario_atual);
    return 0;
}
...
void menuPrincipal(Produto *produtos, int *count, int *venda_id, int *user_count, Usuario *usuarios, Usuario *usuario_atual) {
    ...
    do {
        ...
        switch(opcao) {
            ...
            case 2:
                menuVenda(produtos, count, venda_id);
                break;
...
void menuVenda(Produto *produtos, int *count, int *venda_id){
    ...
    do {
        ...
        printf("3. Mostrar Histórico de Venda Específica\n");
